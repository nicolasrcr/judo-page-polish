...
export const sections = [
  { id: 'home', label: 'Início', labelJp: '始め', icon: '道' },
  { id: 'historia', label: 'História', labelJp: '歴史', icon: '史' },
  { id: 'principios', label: 'Princípios', labelJp: '原則', icon: '心' },
  { id: 'etiqueta', label: 'Etiqueta', labelJp: '礼儀', icon: '礼' },
  { id: 'nomenclatura', label: 'Nomenclatura', labelJp: '用語', icon: '言' },
  { id: 'gokyo', label: 'Gokyo', labelJp: '五教', icon: '投' },
  { id: 'katameWaza', label: 'Katame-Waza', labelJp: '固技', icon: '固' },
  { id: 'katas', label: 'Katas', labelJp: '形', icon: '形' },
  { id: 'nageNoKata', label: 'Nage Kata', labelJp: '投の形', icon: '投形' },
  { id: 'katameNoKata', label: 'Katame Kata', labelJp: '固の形', icon: '固形' },
  { id: 'treinos', label: 'Treinos', labelJp: '稽古', icon: '練' },
  { id: 'regras', label: 'Regras', labelJp: '規則', icon: '則' },
  { id: 'regras2025', label: 'Regras 2025', labelJp: '新規則', icon: '新' },
  { id: 'organizacao', label: 'Organização', labelJp: '組織', icon: '🏟️' },
  { id: 'escolar', label: 'Escolar', labelJp: '学校', icon: '🎓' },
  { id: 'socorros', label: 'Socorros', labelJp: '救急', icon: '🚑' },
  { id: 'inclusivo', label: 'Inclusivo', labelJp: '包括', icon: '♿' },
  { id: 'videos', label: 'Vídeos', labelJp: '動画', icon: '映' },
  { id: 'flashcardsMenu', label: 'Flashcards', labelJp: '暗記', icon: '札' },
  { id: 'quizzes', label: 'Quizzes', labelJp: '問題', icon: '問' },
];
