  ...
  const videoCategories = [
    ...
    },
    {
      ...
      videos: [
        ...
        { name: 'Kibisu-gaeshi', id: 'tJylJYfBliA', gokyo: 'Shinmeisho' },
        { name: 'Uchi-mata-sukashi', id: 'V-RS3uhtVWM', gokyo: 'Shinmeisho' },
        { name: 'Ko-uchi-gaeshi', id: '_MWAdYi_LC4', gokyo: 'Shinmeisho' },
        { name: 'Sode-tsurikomi-goshi', id: 'QsmAxpmYLOI', gokyo: 'Shinmeisho' },
    ...
    },
    {
      ...
      gokyo: undefined,
      videos: [
        { name: 'Ushiro-Ukemi', id: '4DHgmH0aj8I' },
        { name: 'Yoko-Ukemi', id: 'VoktcQAxEPg&t=58s' },
        { name: 'Mae-Ukemi', id: 'lflox2BS1oEs' },
        { name: 'Zenpo-Kaiten-Ukemi', id: 'JyrQtnOjwaA' },
      ] as VideoItem[]
    },
  ];
