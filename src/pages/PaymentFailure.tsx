          ...
          <CardContent className="p-8 md:p-12">
            <div className="text-center space-y-6">
              <div className="bg-destructive/20 border border-destructive/50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-white mb-4">Motivos Comuns de Falha</h3>
                <ul className="space-y-2 text-sm text-muted-foreground text-left">
                  ...
                  <li className="flex gap-3">
                    <span className="text-destructive font-bold">•</span>
                    <span>Cartão bloqueado ou não autorizado</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-destructive font-bold">•</span>
                    <span>Conexão com banco não foi estabelecida</span>
                  </li>
                </ul>
              </div>

              <div className="bg-primary/20 border border-primary/50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-white mb-3">O que você pode fazer?</h3>
                <ul className="space-y-2 text-sm text-muted-foreground text-left">
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">1.</span>
                    <span>Tentar novamente com outro cartão ou método de pagamento</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">2.</span>
                    <span>Usar <strong>PIX</strong> para uma forma de pagamento mais simples</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">3.</span>
                    <span>Contatar seu banco para autorizar a transação</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary font-bold">4.</span>
                    <span>Entre em contato conosco para assistência</span>
                  </li>
                </ul>
              </div>
